...
const RegistrationPage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="w-full max-w-md p-8 bg-[#000000d7] border border-gray-300 rounded-lg shadow-md m-10">
        <h1 className="mb-6 text-3xl text-center text-[#2078d6]">
          Registration
        </h1>
        <Formik
          initialValues={{
          ...
          {({
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="px-4 py-2 font-bold bg-[#2078d6] text-[aliceblue] rounded focus:outline-none focus:shadow-outline transition ease-in-out duration-300 hover:text-black hover:bg-[#2078d68c]"
              >
                Submit
              </button>
            </form>
